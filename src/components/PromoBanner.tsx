...
export default function PromoBanner() {
  ...
  return (
    <section className="w-full bg-[#F9F6F0] relative overflow-hidden py-12 md:py-16 lg:py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mb-6">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#3C2414] font-breathing leading-tight mb-4">
              <div className="inline-flex items-center justify-center mb-4">
                <svg
                  className="w-12 h-12 md:w-16 md:h-16 text-accent-600"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
          ...
          {/* Oferecimento */}
          <p className="text-sm md:text-base italic text-[#3C2414] mb-6 font-body">
            {t("promo.sponsor")}{" "}
            <span className="underline font-semibold">Terra Ventos</span>
          </p>

          {/* Descrição */}
          <p className="text-base md:text-lg text-[#3C2414] mb-8 leading-relaxed font-body max-w-2xl mx-auto">
            {t("promo.description")}
          </p>
          ...
          {/* Contato */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-sm md:text-base text-[#3C2414] font-body">
            <a
